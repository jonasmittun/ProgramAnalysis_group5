...
class SimpleTest {
    ...
    void noop() {
        ...
        Week06.SignInterpreter in = new Week06.SignInterpreter(new HashMap<>(classes), depthLimit);
        in.run(m, mu);
    }
    ...
    class Factorial {
        ...
        void factorial_sets() {
            ...
            Week06.SignInterpreter in = new SignInterpreter(new HashMap<>(classes), depthLimit);
            in.run(m, mu);
        }
    }
}
...
import Week4.ConcreteInterpreter; //TODO: Refactor to SignInterpreter
import Week4.SignInterpreter;
import Week4.Method;
import Week4.Pair;
...
class SimpleTest {
    ...
    void noop() {
        ...
        SignInterpreter in = new SignInterpreter(new HashMap<>(classes), 5);
        in.run(m, mu);
    }
